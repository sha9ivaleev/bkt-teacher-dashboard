...
class Skill(Base):
    ...
    p_learn = Column(Float, default=0.15)
    p_guess = Column(Float, default=0.20)
    p_slip = Column(Float, default=0.10)
    p_init = Column(Float, default=0.20)
...
class StudentKnowledgeState(Base):
    ...
    student_id = Column(Integer, ForeignKey("students.id"))
    skill_id = Column(Integer, ForeignKey("skills.id"))
    probability_knowing = Column(Float, default=0.2)
